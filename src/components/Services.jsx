...
function Services() {
    return (
        <section
            id="services"
            className="py-20 bg-slate-300 text-gray-900 dark:bg-gray-950 dark:text-white transition-colors duration-300"
        >
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-14">
                    ...
                    {/* Chaudronnerie */}
                    <div className="group bg-slate-100 dark:bg-gray-900 p-8 rounded-2xl border border-slate-400 dark:border-gray-800 hover:border-blue-500 transition-all duration-300 hover:-translate-y-2">
